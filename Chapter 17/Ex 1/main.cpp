...
int main(int argc, char *argv[]) {
  ...
  // load texture image
  Texture diffuseMap("../../textures/container2.png", GL_TEXTURE_2D,
                     GL_TEXTURE0, true);
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // render
    // ------
    glClearColor(0.914f, 0.725f, 0.388f, 1.0f);
    ...
    // To modidy the value of the light modify the diffuse color
    ...
    for (int i = 0; i < sizeof(pointLightPositions) / sizeof(glm::vec3); ++i) {
      ...
      lightCubeShader.setVec3("lightColour", pointLightColours[i]);
      model = glm::mat4(1.0f);
