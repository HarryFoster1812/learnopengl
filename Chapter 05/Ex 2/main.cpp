...
int main(int argc, char *argv[]) {
  ...
  float triangle_v2[] = {// second triangle
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(triangle_v1), triangle_v1,
               GL_STATIC_DRAW);
  ...
  // send the vertices to the GPU buffer
  glBufferData(GL_ARRAY_BUFFER, sizeof(triangle_v2), triangle_v2,
               GL_STATIC_DRAW);
